...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/wITg53uBBQ)
...
```sh
npx nx build frontend-workspace
```

To see all available targets to run for a project, run:

```sh
npx nx show project frontend-workspace
```
